...
final class ProductDataStore {
    ...
    private var productData:[Product] = [
        ...
        Product(name:"Lifejacket", description: "Protective and fashinable", category: "Watersports", price:48.95, stockLevel:0),
        ...
        Product(name:"Unsteady Chair", description: "Secretly give your oppenent a disadvantage", category: "Chess", price:29.95, stockLevel:0),
