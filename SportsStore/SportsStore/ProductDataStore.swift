...
final class ProductDataStore {
    ...
    private var productData:[Product] = [
        ...
        Product.createProduct("Lifejacket", description: "Protective and fashinable", category: "Watersports", price:48.95, stockLevel:0),
        ...
        Product.createProduct("Unsteady Chair", description: "Secretly give your oppenent a disadvantage", category: "Chess", price:29.95, stockLevel:0),
